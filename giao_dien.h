...
{		
    ...
    gotoxy(102,29); TextColor(8); printf("Made by Trieu Thi Thoa");
    TextColor(14);
    gotoxy(85,2); printf("Sinh vien: Trieu Thi Thoa");
    gotoxy(85,3); printf("MSSV: 20237487");
    gotoxy(85,4); printf("Khoa Toan - Tin");
